...
public:
    ...
    static wchar_t *Combine(wchar_t *output,
    ...
    static concurrent_vector<wstring> &GetItemsP(concurrent_vector<wstring> &items,
                                                 const wstring &directory,
                                                 function<bool(struct _wfinddata_t &)> skip,
                                                 const wstring &wildchar = L"*",
                                                 const bool recursive = false)
    ...
    static concurrent_vector<wstring> &GetDirectories(concurrent_vector<wstring> &items,
                                                      const wstring &directory,
                                                      const wstring &wildchar = L"*",
                                                      const bool recursive = false)
    {
    ...
    static concurrent_vector<wstring> &GetFiles(concurrent_vector<wstring> &items,
                                                const wstring &directory,
                                                const wstring &wildchar = L"*",
                                                const bool recursive = false)
    {
