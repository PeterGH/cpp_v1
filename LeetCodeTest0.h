#ifndef _LEETCODETEST0_H_
#define _LEETCODETEST0_H_

#include "LeetCodeTest.h"

void LeetCodeTest::Init0(void)
{
    ...
    Add("15. 3Sum", [&]()
        {
            auto check = [&](const vector<int> &n)
            {
                ...
                vector<int> m4(n);
                vector<vector<int>> o4 = threeSum4(m4);
                vector<int> m5(n);
                vector<vector<int>> o5 = threeSum5(m5);
                Util::SortGrid(o);
                Util::SortGrid(o2);
                Util::SortGrid(o3);
                Util::SortGrid(o4);
    ...
    Add("18. 4Sum", [&]()
        {
            auto check = [&](const vector<int> &n, int t)
            {
                ...
                vector<int> m5(n);
                vector<vector<int>> o5 = fourSum5(m5, t);
                vector<int> m6(n);
            ...
            {
                vector<int> v = {
                    -500, -481, -480, -469, -437, -423, -408, -403, -397, -381, -379,
                    -377, -353, -347, -337, -327, -313, -307, -299, -278, -265, -258,
                    -235, -227, -225, -193, -192, -177, -176, -173, -170, -164, -162,
                    -157, -147, -118, -115, -83, -64, -46, -36, -35, -11, 0, 0, 33,
                    40, 51, 54, 74, 93, 101, 104, 105, 112, 112, 116, 129, 133, 146,
                    152, 157, 158, 166, 177, 183, 186, 220, 263, 273, 320, 328, 332,
                    356, 357, 363, 372, 397, 399, 420, 422, 429, 433, 451, 464, 484,
                    485, 498, 499};
                check(v, 2139);
            }
            for (int i = 0; i < 100; i++)
    ...
    Add("92. Reverse Linked List II", [&]()
        {
            auto check = [&](const vector<int> &v, int m, int n)
            {
                ...
                DeleteList(l);
                ListNode *l2 = ToList(v);
                l2 = reverseBetween2(l2, m, n);
                Print(l2);
                vector<int> w2 = ToVector(l2);
                DeleteList(l2);
                ListNode *l3 = ToList(v);
                l3 = reverseBetween3(l3, m, n);
                Print(l3);
                vector<int> w3 = ToVector(l3);
                DeleteList(l3);
                ListNode *l4 = ToList(v);
                l4 = reverseBetween4(l4, m, n);
                Print(l4);
                vector<int> w4 = ToVector(l4);
                DeleteList(l3);
                ASSERT1(0 == Util::Compare(w, w2));
                ASSERT1(0 == Util::Compare(w, w3));
    ...
    Add("144. Binary Tree Preorder Traversal", [&]()
        {
            auto check = [&](const vector<int> &v)
            {
                ...
                vector<int> w3 = preorderTraversal3(t);
                vector<int> w4 = preorderTraversal4(t);
                DeleteTree(t);
                Logger() << w << w2 << w3 << w4;
                ASSERT1(0 == Util::Compare(w, w2));
                ASSERT1(0 == Util::Compare(w, w3));
